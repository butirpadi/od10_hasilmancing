# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'report/hm_report_paper_format.xml',
        'report/hm_delivery_report_view.xml',
        ...
        'views/hm_presensi_karyawan_rel_view.xml',
        ...
        'report/hm_report_gaji_staff.xml',
        'wizard/hm_wiz_gaji_staff_view.xml',
